(function(){
	...
	let setup = {
		...
		create:	function create(){
			...
			this.anims.create({
				key: 'trap',
				frames: this.anims.generateFrameNumbers('trap', { start: 0, end: 12 }),
				frameRate: 48,
			...
			this.anims.create({
				key: 'angled',
				frames: this.anims.generateFrameNumbers('angled', { start: 0, end: 12 }),
				frameRate: 48,
			...
			this.anims.create({
				key: 'closetrap',
				frames: this.anims.generateFrameNumbers('trap', { start: 12, end: 0 }),
				frameRate: 48,
			...
			this.anims.create({
				key: 'closeangled',
				frames: this.anims.generateFrameNumbers('angled', { start: 12, end: 0 }),
				frameRate: 48,
