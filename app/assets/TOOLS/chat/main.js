//(function(){
	...
	let chinese_names = {
		...
		10.2: {'Alan': '郜彦哲', 'Amy': '侯景媛', 'Annie': '熊思雅', 'Bill': '梁贝尔', 'Bob': '侯泽林', 'Casey': '赵曼可', 'Cecilia': '刘一帆', 'Frank': '郑琪烁', 'George Zhe': '张哲', 'Helen': '郭怡媛', 'Irene': '李晨熙', 'James': '王泰寓', 'Jenny': '徐越洋', 'Jim': '田紫晗', 'Jonathan': '袁浩喆', 'Lydia': '孙红娇', 'Mike': '杨御钦', 'Steven': '董哲琨', 'Timmy': '丁麒霖', 'Tommy': '赵桐祥'}, 
		10.3: {'Aaron': '张一统', 'Allen': '段成誉', 'Arie': '霍奕名', 'Bob': '王禹豪', 'Dale': '张壹斐', 'George Runlong': '张润龙', 'James': '胡孝典', 'Lori': '周俊彤', 'Rebecca': '潘迎好', 'Susan': '李嘉琪', 'Tony': '王文康', 'Zack': '苏昭朔'}, 
		...
		12: {'Alan': '谢璐阳', 'Amanda': '张琦', 'Ares': '魏星宇', 'Barry Allen': '郝珈铭', 'Bary': '周也涛', 'Buford': '吕祎玮', 'David': '张沅朋', 'Kevin': '张一行', 'Lynn': '李欣雨', 'Mark': '张皓源', 'Michael': '张益持枫', 'Nancy': '刘冰姿', 'Robert': '张博康', 'Scott': '朱少坤', 'Tony': '唐子维', 'Yvette': '王悦懿', 'Zed': '赵楚涵'}, '12.2': {}}
		...
		init: function(){
			...
			this.for_each_name((name, cls) => {
					...
					this.students[name + ' ' + cls] = {
						...
						chinese: chinese_names[cls][first]
					}
			})
		},
